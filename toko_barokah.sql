...
CREATE TABLE `fact_penjualan`  (
  ...
  CONSTRAINT `fact_penjualan_ibfk_3` FOREIGN KEY (`id_member`) REFERENCES `dim_customer` (`id_member`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
